...
from cosmos_curator.core.utils.storage import azure_client, s3_client
from cosmos_curator.core.utils.storage.azure_client import AzurePrefix, is_azure_path
