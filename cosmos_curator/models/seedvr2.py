...
class SeedVR2(ModelInterface):
    ...
    def setup(self) -> None:
        ...
        from cosmos_curator.pipelines.video.super_resolution.inference_seedvr2_window import (  # noqa: PLC0415
            configure_runner,
        )
        ...
        #   - Source: $SEEDVR_ROOT (e.g. /opt/cosmos-curator/SeedVR from the tarball)
