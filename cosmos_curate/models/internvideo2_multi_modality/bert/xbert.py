...
# Modifications: bug fixes and Python/PyTorch compatibility
#
...
class BertConfig(PretrainedConfig):
    r"""This is the configuration class to store the configuration of a [`BertModel`] or a [`TFBertModel`]. It is used to
...
class BertEncoder(nn.Module):
    ...
    def forward(
        ...
        if mode == "text" or mode == "temporal":  # temporal is added and used for temporal att module.
            start_layer = 0
...
class BertForPreTraining(BertPreTrainedModel):
    ...
    @replace_return_docstrings(
        output_type=BertForPreTrainingOutput,
    ...
    def forward(
        ...
        r"""Labels (:obj:`torch.LongTensor` of shape ``(batch_size, sequence_length)``, `optional`):
...
class MaskedLMOutputWithDistill(MaskedLMOutput):
    loss_aux: torch.FloatTensor | None = None
    loss_distill: torch.FloatTensor | None = None
...
class BertForNextSentencePrediction(BertPreTrainedModel):
    ...
    def forward(
        ...
        **kwargs,
        ...
        r"""Labels (:obj:`torch.LongTensor` of shape :obj:`(batch_size,)`, `optional`):
            Labels for computing the next sequence prediction (classification) loss. Input should be a sequence pair
...
class BertForQuestionAnswering(BertPreTrainedModel):
    ...
    def forward(
        ...
        r"""start_positions (:obj:`torch.LongTensor` of shape :obj:`(batch_size,)`, `optional`):
